...
import 'package:ttd_learner/src/features/post/views/post_response_screen.dart';
...
class PostWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: InkWell(
        onTap: () {
          PostController.instance.fetchPostDetails(post.id!);
          Get.to(() => PostResponseScreen(
                post: post,
              ));
        },
        child: Container(
                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        Container(
                          width:
                              Get.width - 4 * Dimensions.zDefaultPadding - 50,
                          child: Text(
                            post.title ?? "",
                            style: TextStyle(
                              color: zTextColor,
